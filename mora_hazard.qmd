...
The notes borrow heavily from @Lambert_2001, @Bolton_Dewatripont_2005, and the PhD material elaborated by [Jeremy Bertomeu](https://sites.google.com/site/jeremybertomeu/) and  [Edwige Cheynel](https://olin.wustl.edu/faculty/edwige-cheynel), available from their website.
...
where  $\sigma_x^2$ is the variance of $\epsilon_x$, $\sigma_y^2$ is the variance of $\epsilon_y$, and $\rho$ is the correlation coefficient between $\epsilon_x$ and $\epsilon_y$. The **accounting system** aggregates both signals into a performance measure  $\pi=\pi(x,y)$.The @eq-optimal_weights_2  becomes
